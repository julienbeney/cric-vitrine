...
export default function AboutUs() {
  return (
    <div className="flex h-screen flex-col align-middle justify-between items-start text-center w-96 md:w-7/12 lg:w-128 xl:w-7/12 mx-auto z-20  ">
      <div>
        <Title title={"What does CRIC offer ?"} />
        ...
        <Card className="w-full mt-6 py-4 p-3 sm:p-4 lg bg-gradient-to-br from-transparent to-[hsl(var(--muted))] justify-between text-left">
          ...
          <p className="text-muted-foreground text-sm md:text-lg my-6">
            We are a small team of 2 people, we are a small company. We are not
            a VC funded startup. We are not looking for investors. We want to
            keep our freedom and build a substainable business while working on
            features that provides the best value to our users. We also want to
            be transparent about our business. We are not going to hide our ups
            and downs. We are going to share our journey with you.
          </p>
          ...
          <p className="text-muted-foreground text-sm md:text-lg mt-6">
            ...
            platform that helps developers monitor their websites and APIs. We
            are here to fight Us-East-1 privilege. ⚔️
          </p>
        </Card>
      </div>
      <Footer />
